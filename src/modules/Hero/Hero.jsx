...
export const Hero = () => (
  <section className={_.hero}>
    <div className="container">
      <div className={_.hero__headGroup}>
        <h1 className={_.hero__title}>Авторские букеты</h1>
        <p className={_.hero__subtitle}>и подарки</p>
      </div>

      <figure className={_.hero__groupImage}>
        <picture className={_.hero__image + ' ' + _.hero__image_left}>
          <source
        ...
        <svg className={_.hero__image + ' ' + _.hero__image_center} role="img"
          ...
          <foreignObject clipPath="url(#hero)" width="100%" height="100%">
            <div className={_.hero__imageCenter}></div>
          </foreignObject>

        </svg>


        <picture className={_.hero__image + ' ' + _.hero__image_right}>
          <source
