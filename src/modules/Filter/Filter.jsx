...
export const Filter = () => {
  const isOpenPrice = useSelector(state => state.choices.isOpenPrice);
  const isOpenTypeProduct = useSelector(state => state.choices.isOpenTypeProduct);
      ...
      <div className="container">
        <form className={_.filter__form}>
          ...
          <fieldset className={_.filter__group + ' ' + _.filter__group_choices}>
            <Choices btnLabel="Цена" type='prise'>
              {isOpenPrice &&
            ...
            <Choices btnLabel="Тип товара" className={_.filter__choice_type} type='typeProduct'>
              {isOpenTypeProduct &&
                <div className={_.filter__choicesBox} >
